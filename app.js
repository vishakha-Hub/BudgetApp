   ...
   var totalExpenses = 0; 
    ...
    return{
        ...
        calculateBudget: function(){
            ...
            //cal the persentage of income that we spent
...
var formatNumber = function(num, type){
    ...
    return{
        ...
        addListItem: function(obj, type){
            ...
            //1. create HTML string with placeholder tag
        ...
        displayBudget: function(obj){
           ...
           /* document.querySelector(DOMstrings.percentageLable).textContent = formatNumber(obj.percentage, percentage);*/
        ...
        displayMonth: function(){
            ...
            now = new Date();
            //var chrismas = new Date(2010,11,25);
...
var controller = (function(budgetCtrl, UICtrl){
  ...
  var updatePercentages = function(){
      ...
      //1.calcualte percentage
      budgetCtrl.calculatePercentages();
      
      //2. Read percentage from te bufget controller
  ...
  var ctrlAddItem = function(){
      ...
      //6.calcualte and update percentage
       updatePercentages();
      }
